  ...
  return (
    <div className="flex flex-col items-center p-28 mt-32">
      <div className="flex pb-4 gap-4 items-end">
        ...
        <Modal width="w-80" bgColor="bg-[#CCCCCC]" delay="0.1">
        ...
        <Modal width="w-52" bgColor="bg-[#E27022]" borderColor="border-black" delay="0.2">
      ...
      <div className="flex pb-4 gap-4 items-start">
        ...
        >
          <Modal width="w-56" bgColor="bg-[#E27022]" borderColor="border-black" delay="0.2">
        ...
        <Modal width="w-96" bgColor="bg-[#E27022]" borderColor="border-black" delay="0.4">
          <BlogList />
        </Modal>

        <Modal width="w-44" bgColor="bg-[#CCCCCC]" delay="0.5">
